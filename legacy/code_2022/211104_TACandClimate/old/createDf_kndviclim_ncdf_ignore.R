...
input_kndvi <- 'data_processing/createDF_kndviclim/merged_kndvi_2003_2021_deseasonalised_005_con.nc'
...
input_swvl1 <- 'data/climate/8day/SM/SM_3_europe/resolution/SM_allY_timsel8_europe3nn.nc'
...
head(df_kndvi) ; dim(df_kndvi)  # summary(df_kndvi)
...
# head(df_spei) ; dim(df_spei)  # summary(df_spei)
