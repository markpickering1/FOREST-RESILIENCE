...
# this script initialises certain environmental variables in order to run the bash scripts in a consistent manner
...
# dir of code
ROOT_CODE="/eos/jeodpp/data/projects/FOREST-RESILIENCE/GIT-FOREST-RESILIENCE/FOREST-RESILIENCE/"
