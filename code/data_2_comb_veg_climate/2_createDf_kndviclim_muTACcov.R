...
script_info_full <- 'createDF_kndviclim_fullTS'                 # load input dataframes containing full data and residuals
...
input_dir <- paste0(root_data_proce, script_info_full, '/', script_info_full, '_', full_date,  '/')
